...
To find the subgroups of the additive group $\mathbb{Z}_{12}$, we rely on the properties of cyclic groups. By \textbf{Theorem 6.6} (or fundamental theorem of cyclic groups), every subgroup of a cyclic group is itself cyclic. Furthermore, for a finite cyclic group of order $n$, there is a unique subgroup of order $k$ for every divisor $k$ of $n$. We find these by looking at generators $\langle n/k \rangle$.
