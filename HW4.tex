...
General Idea: To find the subgroups of the additive group $\mathbb{Z}_{12}$, we rely on the properties of cyclic groups. By Theorem 6.6, every subgroup of a cyclic group is itself cyclic.
